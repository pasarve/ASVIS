...
define('EMAIL', 'arvydas.berteska@gmail.com');
...
define ('BASE_URL', 'http://arvydelis.eu/');
...
function my_error_handler ($e_number, $e_message, $e_file, $e_line, $e_vars) {
	...
	$message = "<p>Įvyko klaida šiame faile: '$e_file' ties šia linija: $e_line: $e_message\n<br />";
	...
	if (!LIVE) { // Development (print the error).
		...
		//mail(EMAIL, 'Site Error!', $message, 'From: pasarve@gmail.com');
		
		// Only print an error message if the error isn't a notice:
		if ($e_number != E_NOTICE) {
			//echo '<div class="error">Įvyko sisteminė klaida. Atsiprašome už nesklandumus.</div><br />';
		}
	} // End of !LIVE IF.
