...
if ($x && $y) {
	...
	if (mysqli_affected_rows($dbc) == 1) {
		echo "<h3>Jūsų prisijungimo duomenys yra aktyvūs. Galite prisijungti.</h3>";
	} else {
		echo '<p class="error">Jūsų duomenys nebuvo aktyvuoti. Patikrinkite nuorodą arba susisiekite su sistemos administratoriumi.</font></p>'; 
	}
